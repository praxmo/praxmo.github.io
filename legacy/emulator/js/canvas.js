...
/**
 * Renders a JSON graph with nodes and edges using the HTML canvas element
 *
...
function drawStaticConstellation(data, params, target, class_for_width, class_for_height) {
  ...
  function Renderer(elm, class_for_width, class_for_height, graph) {
    ...
    var ifps = 85;
    var FPS_FAST = params.fps || 75; //redraw every 75ms; this can be reset by the user during configuration
    var FPS_SLOW = 150;              //redraw every 150ms when the constellation isn't being actively modified
    var fps = FPS_FAST;
