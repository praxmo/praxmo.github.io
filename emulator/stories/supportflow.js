var supportflow = {
  ...
  "users": {
    ...
    "supportflow": {
      "id": "supportflow",
      "title": "Intwixt SupportFlow",
      "avatar": "supportflow_96.png"
    },
    "a2": {
      "id": "a2",
      "title": "Aito.ai",
    ...
    "events": [
      ...
      //type a message to query the bot using NLP; it will be bound to the active user (sent by)
      {
        ...
        "annotation": {
          "user": "u1",
          "role": "Sales Managers",
          "text": "can query SupportFlow using natural language to get insight into new leads."
        },
        "pause": 2500,
        "step_next": true
      },
