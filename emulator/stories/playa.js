var playa = {
  ...
  //this is the story board. this is used to tell the story; it starts in an `playing` state which also causes the loop
  "story_board": {
    "state": "playing",
        ...
        "action": {
          ...
          "message": {
            ...
            "actions": {
              "refresh": {
                "id": "refresh",
                "title": "Refresh Intercom Details"
              },
              "claim": {
                "id": "claim",
                "title": "Claim Lead"
